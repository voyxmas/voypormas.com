                <form id="main_search" action="<?php echo base_url() . 'app/home' ?>" method="get">
                    <a id="search_toggle_button" class="collapsed" href="#" data-toggle="collapse" data-target="#search_toggle"><span><i class="fa fa-caret-down" aria-hidden="true"></i>
</span> <span><i class="fa fa-caret-up" aria-hidden="true"></i>
</span></a>
