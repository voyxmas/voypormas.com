...
<html lang="es">
    ...
    <head>
        ...
        <link href="<?php echo base_url().APP_ASSETS_FOLDER ?>/pages/css/coming-soon.min.css" rel="stylesheet" type="text/css" />
    ...
    <body class="">
        <div class="container">
            <div class="row">
                <div class="col-md-12 coming-soon-header">
                    <a class="brand" href="index.html">
                        <img src="<?php echo base_url().APP_ASSETS_FOLDER ?>/global/imgs/logos/logo-full.png" alt="logo" /> </a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 coming-soon-content">
                    <h1>Muy pronto!</h1>
                    <p>Estamos trabajando para traerte toda la información sobre maratones y eventos relacionados para profesionales y amateurs.</p>
                    <br>
                </div>
            ...
            <!--/end row-->
            <div class="row">
                <div class="col-md-12 coming-soon-footer"> 2017 &copy; Voypormas!com </div>
            </div>
        </div>
        <!--[if lt IE 9]>
...
<![endif]-->
        ...
        <!-- END CORE PLUGINS -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <script src="<?php echo base_url().APP_ASSETS_FOLDER ?>/plugins/scripts/jquery.countdown.min.js" type="text/javascript"></script>
        <script src="<?php echo base_url().APP_ASSETS_FOLDER ?>/plugins/scripts/jquery.backstretch.min.js" type="text/javascript"></script>
        <!-- END PAGE LEVEL PLUGINS -->
        <!-- BEGIN THEME GLOBAL SCRIPTS -->
        <!-- END THEME GLOBAL SCRIPTS -->
        <!-- BEGIN PAGE LEVEL SCRIPTS -->
        <script src="<?php echo base_url().APP_ASSETS_FOLDER ?>/pages/scripts/coming-soon.min.js" type="text/javascript"></script>
