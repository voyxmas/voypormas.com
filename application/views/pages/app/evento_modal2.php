...
<div class="modal-body">
    ...
    <div id="variantes" >
        ...
        <p><strong><?php echo $varianteItem['distancia'] ?>Km</strong><br>
        Lugar de largada: <?php echo $varianteItem['lugar_largada'] ?> - <?php echo $varianteItem['hora_largada'] ?><br>
        Entrega de kit: <?php echo $varianteItem['kit_lugar'] ?> - <?php echo $varianteItem['kit_hora'] ?><br>
        Elementos obligatorios: <?php echo $varianteItem['info'] ?><br></p>
        <?php endforeach ?>
